# ChannelEngine\Merchant\ApiClient\SettlementApi
...
```php
settlementGetByFilter($channelIds, $fromStartDate, $toStartDate, $fromEndDate, $toEndDate, $fromCreateDate, $toCreateDate, $fromUpdateDate, $toUpdateDate, $page): \ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantReportsResponse
```
...
$apiInstance = new ChannelEngine\Merchant\ApiClient\Api\SettlementApi(
...
[**\ChannelEngine\Merchant\ApiClient\Model\CollectionOfMerchantReportsResponse**](../Model/CollectionOfMerchantReportsResponse.md)
